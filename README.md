...
<div align="center">
  ...
  <h2><b>Test-driven development Project</b></h2>
...
**Test-driven development** is a coding challeng at Microverse's Module 4.
...
Test the methods of a class Solver
...
```sh
  cd my-folder
  git clone https://github.com/AleWaweru/test-driven-development.git
```
...
Feel free to check the [issues page](https://github.com/AleWaweru/test-driven-development/issues).
